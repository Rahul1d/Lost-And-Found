...
import com.Trylof.services.service.ItemVerificationLocalService;
...
/**
 * Provides the base implementation for the item verification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.Trylof.services.service.impl.ItemVerificationLocalServiceImpl}.
 * </p>
 *
 * @author Utkarsh
 ...
 */
@ProviderType
public abstract class ItemVerificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ItemVerificationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.Trylof.services.service.ItemVerificationLocalServiceUtil} to access the item verification local service.
	 */
	...
	public ItemVerification addItemVerification(
		...
		return itemVerificationPersistence.update(itemVerification);
	}
	...
	public ItemVerification createItemVerification(long itemVerificationId) {
		return itemVerificationPersistence.create(itemVerificationId);
	}
	...
	public ItemVerification deleteItemVerification(long itemVerificationId)
		...
		return itemVerificationPersistence.remove(itemVerificationId);
	}
	...
	public ItemVerification deleteItemVerification(
		ItemVerification itemVerification) {
		return itemVerificationPersistence.remove(itemVerification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ItemVerification.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return itemVerificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return itemVerificationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ItemVerification fetchItemVerification(long itemVerificationId) {
		return itemVerificationPersistence.fetchByPrimaryKey(itemVerificationId);
	}
	...
	public ItemVerification getItemVerification(long itemVerificationId)
		throws PortalException {
		return itemVerificationPersistence.findByPrimaryKey(itemVerificationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(com.Trylof.services.service.ItemVerificationLocalServiceUtil.getService());
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ItemVerification.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("itemVerificationId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(com.Trylof.services.service.ItemVerificationLocalServiceUtil.getService());
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ItemVerification.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return itemVerificationLocalService.deleteItemVerification((ItemVerification)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return itemVerificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ItemVerification> getItemVerifications(int start, int end) {
		return itemVerificationPersistence.findAll(start, end);
	}
	...
	public int getItemVerificationsCount() {
		return itemVerificationPersistence.countAll();
	}
	...
	public ItemVerificationImage1BlobModel getImage1BlobModel(
		...
		try {
			session = itemVerificationPersistence.openSession();

			return (ItemVerificationImage1BlobModel)session.get(ItemVerificationImage1BlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw itemVerificationPersistence.processException(e);
		}
		finally {
			itemVerificationPersistence.closeSession(session);
		}
	}
	...
	public ItemVerificationImage2BlobModel getImage2BlobModel(
		...
		try {
			...
			return (ItemVerificationImage2BlobModel)session.get(ItemVerificationImage2BlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw itemVerificationPersistence.processException(e);
	 ...
	 */
	public ItemVerificationLocalService getItemVerificationLocalService() {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.Trylof.services.model.ItemVerification",
			itemVerificationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ItemVerificationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = itemVerificationPersistence.getDataSource();
	...
	protected ItemVerificationLocalService itemVerificationLocalService;
	...
	private ItemVerificationLocalServiceClpInvoker _clpInvoker = new ItemVerificationLocalServiceClpInvoker();
}