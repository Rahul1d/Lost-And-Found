...
/**
 * Provides the local service interface for SearchRes. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Utkarsh
 * @see SearchResLocalServiceUtil
...
public interface SearchResLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SearchResLocalServiceUtil} to access the search res local service. Add custom service methods to {@link com.Trylof.services.service.impl.SearchResLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
