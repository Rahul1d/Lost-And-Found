...
<portlet:actionURL var="claimUrl" name="submitClaim"></portlet:actionURL>
...
<aui:input name="file" label="Upload Image of item Lost" type="file" />
<aui:button name="Submit" type="submit" value="Request claim" ></aui:button>
